...
function useNavigateUnstable() {
  ...
  let routePathnamesJson = JSON.stringify(
    UNSAFE_getResolveToMatches(matches, future.v7_relativeSplatPath)
  );
...
const defaultErrorElement = /*#__PURE__*/ React.createElement(
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  if (errors != null) {
    let errorIndex = renderedMatches.findIndex(
      (m) =>
        m.route.id &&
        (errors == null ? void 0 : errors[m.route.id]) !== undefined
    );
    !(errorIndex >= 0)
      ? process.env.NODE_ENV !== "production"
        ? UNSAFE_invariant(
...
function useMatches() {
  ...
  return React.useMemo(
    () => matches.map((m) => UNSAFE_convertRouteMatchToUiMatch(m, loaderData)),
    [matches, loaderData]
  );
}
