...
const Ht =
  ...
  Ft = ({ children: r, className: e, position: t = "start", ...n }) =>
    /* @__PURE__ */ c(Ct, {
  ...
  Nt = (r) => {
    const { rgbColor: e, style: t, className: n, ...a } = r,
      s = {
        "--rgb-r": e.r,
        "--rgb-g": e.g,
        "--rgb-b": e.b,
...
const at = {
  ...
  Dt = (r) => {
    const { hsv: e, onChange: t, currentHue: n } = r,
      a = d.useRef(!1),
      s = d.useRef(null),
      [o, i] = d.useState(!1),
      f = Lt((p, k) => {
    ...
    d.useEffect(
      () => (
        document.addEventListener("pointermove", b, !1),
        document.addEventListener("pointerup", w, !1),
        () => {
          document.removeEventListener("pointermove", b, !1),
            document.removeEventListener("pointerup", w, !1);
        }
      ),
      [w, b]
    );
    ...
    return /* @__PURE__ */ c(at.Space, {
      ...
      role: "slider",
      "aria-valuetext": `Saturation ${st(M, 0, 0)}%, Brightness ${st(
        C,
        0,
        0
      )}%`,
  ...
  return (
    ...
    typeof r == "object" &&
      (A(r.r) && A(r.g) && A(r.b)
        ? ((e = Ut(r.r, r.g, r.b)),
          (o = !0),
          (i = String(r.r).substr(-1) === "%" ? "prgb" : "rgb"))
        : A(r.h) && A(r.s) && A(r.v)
        ? ((n = G(r.s)),
          (a = G(r.v)),
          (e = Yt(r.h, n, a)),
...
class h {
  ...
  setAlpha(e) {
    return (
      (this.a = gt(e)), (this.roundA = Math.round(100 * this.a) / 100), this
    );
  }
  /**
  ...
  toString(e) {
    ...
    return !t && a && (e.startsWith("hex") || e === "name")
      ? e === "name" && this.a === 0
        ? this.toName()
        : this.toRgbString()
  ...
  monochromatic(e = 6) {
    ...
    const o = [],
      i = 1 / e;
    for (; e--; ) o.push(new h({ h: n, s: a, v: s })), (s = (s + i) % 1);
    return o;
  }
  splitcomplement() {
    const e = this.toHsl(),
...
const ne = (r) => {
    const { currentColor: e, format: t, onChange: n, isAlphaHidden: a } = r,
      [s, o] = d.useState(e.toHsv()),
      i = (b, m) => {
        if (!nt(m)) return;
...
function ft(r, e) {
  typeof e == "function"
    ? e(r)
    : e && ie(e) && "current" in e && (e.current = r);
}
function me(r) {
  return new h(r).isValid;
}
const xe = d.forwardRef((r, e) => {
  const {
      value: t,
      format: n,
      onChange: a,
    ...
    { onBlur: S, InputProps: M, ...C } = m,
    { onClose: p, ...k } = o || {},
    R = f || ae,
    H = C.disabled || M?.disabled || !1,
    T = d.useRef(null),
    $ = d.useRef(null),
    [J, Q] = d.useState(null),
    P = n || oe,
...
export { xe as MuiColorInput, me as matchIsValidColor };
