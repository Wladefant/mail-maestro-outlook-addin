...
var setInRecursor = function setInRecursor(
  ...
  if (isNaN(key)) {
    ...
    if (_result2 === undefined) {
      ...
      current[key];
      var _final = _objectWithoutPropertiesLoose(
        current,
    ...
    return _extends(
      {},
      current,
      ((_extends2 = {}), (_extends2[key] = _result2), _extends2)
    );
  }
  // array set
...
function createForm(config) {
  ...
  var runRecordLevelValidation = function runRecordLevelValidation(setErrors) {
    ...
    if (validate) {
      ...
      if (isPromise(errorsOrPromise)) {
        promises.push(
          errorsOrPromise.then(function (errors) {
  ...
  var runValidation = function runValidation(fieldChanged, callback) {
    ...
    var promises = [].concat(
      runRecordLevelValidation(function (errors, wasAsync) {
        if (wasAsync) {
      ...
      var forEachError = function forEachError(fn) {
        fieldKeys.forEach(function (name) {
          if (fields[name]) {
            ...
            var hasFieldLevelValidation = getValidators(
              safeFields[name]
            ).length;
  ...
  var calculateNextFormState = function calculateNextFormState() {
    ...
    var dirtyFieldsSinceLastSubmit = safeFieldKeys.reduce(function (
      result,
      key
    ) {
      // istanbul ignore next
    ...
    formState.dirtySinceLastSubmit = !!(
      ...
      Object.values(dirtyFieldsSinceLastSubmit).some(function (value) {
        return value;
      })
    );
  ...
  var api = {
    ...
    initialize: function initialize(data) {
      ...
      // save dirty values
      var savedDirtyValues = keepDirtyOnReinitialize
        ? Object.keys(safeFields).reduce(function (result, key) {
