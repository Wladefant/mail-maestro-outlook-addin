  ...
  _createClass(Transition, [
    {
      ...
      get: function get() {
        ...
        var node =
          (_this$props$nodeRef = this.props.nodeRef) === null ||
...
function getTranslateValue(direction, node) {
  ...
  switch (direction) {
    case "left":
      return (
        "translateX(" +
        (containerWindow.innerWidth + offsetX - rect.left) +
        "px)"
      );
    ...
    case "up":
      return (
        "translateY(" +
        (containerWindow.innerHeight + offsetY - rect.top) +
        "px)"
      );
...
var Slide = /*#__PURE__*/ forwardRef(function (props, ref) {
  ...
  var handleEntering = function handleEntering(node) {
    var easing =
      (style === null || style === void 0
        ? void 0
        : style.transitionTimingFunction) || defaultEasing.easeOut;
  ...
  var handleExit = function handleExit(node) {
    var easing =
      (style === null || style === void 0
        ? void 0
        : style.transitionTimingFunction) || defaultEasing.sharp;
    var transitionProps = getTransitionProps({
      timeout: timeout,
      mode: "exit",
      style: _extends({}, style, {
...
var getAutoHideDuration = function getAutoHideDuration(
  optionsDuration,
  propsDuration
) {
...
var getTransitionDuration = function getTransitionDuration(
  optionsDuration,
  propsDuration
) {
...
function makeStyles(styles) {
  return Object.entries(styles).reduce(function (acc, _ref) {
    ...
    return _extends(
      {},
      acc,
      ((_extends2 = {}), (_extends2[key] = css(value)), _extends2)
    );
  }, {});
}
...
var MaterialDesignContent = /*#__PURE__*/ forwardRef(function (
  props,
  forwardedRef
) {
  var id = props.id,
  ...
  return React__default.createElement(
    SnackbarContent,
    {
      ...
      className: clsx(
        ...
        classes$2[variant],
        className,
        !hideIconVariant && icon && classes$2.lessPadding
      ),
    },
...
var SnackbarItem = function SnackbarItem(props) {
  ...
  var snack = props.snack,
    ...
    Component =
      _props$Component === void 0 ? MaterialDesignContent$1 : _props$Component;
  var classes = useMemo(
    function () {
  ...
  var open = snack.open,
    ...
    otherSnack = _objectWithoutPropertiesLoose(snack, [
      "open",
      "SnackbarProps",
      "TransitionComponent",
      "TransitionProps",
  ...
  var callbacks = ["onEnter", "onEntered", "onExit", "onExited"].reduce(
    function (acc, cbName) {
      var _extends2;
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        content ||
          React__default.createElement(Component, Object.assign({}, otherSnack))
      )
    )
  );
};
...
var styles$1 = /*#__PURE__*/ makeStyles({
  root:
    ...
    (_root$1.maxWidth = "calc(100% - " + indents.view["default"] * 2 + "px)"),
    (_root$1[breakpoints.downXs] = {
      width: "100%",
...
var SnackbarContainer = function SnackbarContainer(props) {
  ...
  var combinedClassname = clsx(
    ...
    classes["containerAnchorOrigin" + originKeyExtractor(anchorOrigin)],
...
var SnackbarProvider = /*#__PURE__*/ (function (_Component) {
  ...
  function SnackbarProvider(props) {
    ...
    _this.enqueueSnackbar = function (messageOrOptions, optsOrUndefined) {
      ...
      var opts = isOptions(messageOrOptions)
        ? messageOrOptions
        : optsOrUndefined;
      var message = isOptions(messageOrOptions)
        ? messageOrOptions.message
        : messageOrOptions;

      var key = opts.key,
        preventDuplicate = opts.preventDuplicate,
        options = _objectWithoutPropertiesLoose(opts, [
          "key",
          "preventDuplicate",
        ]);
    ...
    _this.state = {
      ...
      queue: [],
      contextValue: {
        enqueueSnackbar: _this.enqueueSnackbar.bind(
        ...
        snacks.map(function (snack) {
          return React__default.createElement(SnackbarItem, {
            ...
            onExited: createChainedFunction(
              [_this2.handleExitedSnack, _this2.props.onExited],
              snack.id
            ),
            onEntered: createChainedFunction(
              [_this2.handleEnteredSnack, _this2.props.onEntered],
              snack.id
            ),
          });
        })
