  ...
  $(
    { target: "Uint8Array", stat: true, forced: true },
    {
      fromBase64: function fromBase64(string /* , options */) {
        aString(string);
        var options =
          arguments.length > 1 ? anObjectOrUndefined(arguments[1]) : undefined;
        var alphabet =
        ...
        if (input.length % 4 === 0) {
          ...
          throw new SyntaxError("Input is not correctly padded");
        ...
        var at = function (shift) {
          ...
          if (!hasOwn(alphabet, chr))
            throw new SyntaxError('Bad char in input: "' + chr + '"');
        ...
        if (lastChunkSize === 2) {
          if (strict && bytes[byteLength - 2] !== 0)
            throw new SyntaxError(EXTRA_BITS);
          byteLength -= 2;
