...
var _getDisplayName = _interopRequireDefault(
  require("@mui/utils/getDisplayName")
);
...
function processStyleArg(callableStyle, _ref) {
  ...
  if (
    ...
    const { variants = [] } = resolvedStylesArg,
      otherStyles = (0, _objectWithoutPropertiesLoose2.default)(
        resolvedStylesArg,
        _excluded2
      );
    ...
    variants.forEach((variant) => {
      ...
      if (typeof variant.props === "function") {
        ...
        Object.keys(variant.props).forEach((key) => {
          if (
            (ownerState == null ? void 0 : ownerState[key]) !==
              variant.props[key] &&
  ...
  return (tag, inputOptions = {}) => {
    ...
    const muiStyledResolver = (styleArg, ...expressions) => {
      ...
      const expressionsWithDefaultTheme = expressions
        ? expressions.map(transformStyleArg)
        : [];
      ...
      if (process.env.NODE_ENV !== "production") {
        let displayName;
        if (componentName) {
          displayName = `${componentName}${(0, _capitalize.default)(
            componentSlot || ""
          )}`;
        }
