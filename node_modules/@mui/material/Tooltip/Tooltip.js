...
const Tooltip = /*#__PURE__*/ React.forwardRef(function Tooltip(inProps, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    React.useEffect(() => {
      if (
        childNode &&
        !childNode.getAttribute("data-mui-internal-clone-element")
      ) {
        console.error(
          [
  ...
  const PopperComponent =
    (_ref =
      (_slots$popper = slots.popper) != null
        ? _slots$popper
        : components.Popper) != null
      ? _ref
      : TooltipPopper;
  ...
  const TooltipComponent =
    (_ref4 =
      (_slots$tooltip = slots.tooltip) != null
        ? _slots$tooltip
  ...
  const ArrowComponent =
    (_ref5 =
      (_slots$arrow = slots.arrow) != null ? _slots$arrow : components.Arrow) !=
    null
      ? _ref5
      : TooltipArrow;
  const popperProps = appendOwnerState(
    ...
    _extends(
      {},
      PopperProps,
      (_slotProps$popper = slotProps.popper) != null
        ? _slotProps$popper
  ...
  const tooltipArrowProps = appendOwnerState(
    ...
    _extends(
      {},
      (_slotProps$arrow = slotProps.arrow) != null
        ? _slotProps$arrow
