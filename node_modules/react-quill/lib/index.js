...
var ReactQuill = /** @class */ (function (_super) {
  ...
  ReactQuill.prototype.shouldComponentUpdate = function (nextProps, nextState) {
    ...
    return __spreadArrays(this.cleanProps, this.dirtyProps).some(function (
      prop
    ) {
  ...
  ReactQuill.prototype.setEditorTabIndex = function (editor, tabIndex) {
    var _a, _b;
    if (
      (_b = (_a = editor) === null || _a === void 0 ? void 0 : _a.scroll) ===
        null || _b === void 0
        ? void 0
        : _b.domNode
    ) {
  ...
  ReactQuill.prototype.render = function () {
    ...
    return react_1.default.createElement(
      "div",
      {
        ...
        className:
          "quill " +
          ((_a = this.props.className), _a !== null && _a !== void 0 ? _a : ""),
  ...
  ReactQuill.prototype.onEditorChangeText = function (
    value,
    delta,
    source,
    editor
    ...
    if (nextContents !== this.getEditorContents()) {
      ...
      (_b = (_a = this.props).onChange) === null || _b === void 0
        ? void 0
        : _b.call(_a, value, delta, source, editor);
    }
  };
  ReactQuill.prototype.onEditorChangeSelection = function (
    nextSelection,
    source,
    editor
  ) {
    ...
    (_b = (_a = this.props).onChangeSelection) === null || _b === void 0
      ? void 0
      : _b.call(_a, nextSelection, source, editor);
    if (hasGainedFocus) {
      (_d = (_c = this.props).onFocus) === null || _d === void 0
        ? void 0
        : _d.call(_c, nextSelection, source, editor);
    } else if (hasLostFocus) {
      (_f = (_e = this.props).onBlur) === null || _f === void 0
        ? void 0
        : _f.call(_e, currentSelection, source, editor);
    }
  };
