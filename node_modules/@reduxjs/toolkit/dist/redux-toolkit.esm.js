...
var createDraftSafeSelector = function () {
  ...
  var wrappedSelector = function (value) {
    ...
    return selector.apply(
      void 0,
      __spreadArray([isDraft(value) ? current(value) : value], rest)
    );
  };
...
import createNextState2, {
  isDraft as isDraft2,
  isDraftable as isDraftable2,
} from "immer";
// src/mapBuilders.ts
...
function isAsyncThunkAction() {
  ...
  return function (action) {
    var matchers = [];
    for (
      var _i = 0, asyncThunks_1 = asyncThunks;
      _i < asyncThunks_1.length;
      _i++
    ) {
...
function createListenerMiddleware(middlewareOptions) {
  ...
  var findListenerEntry = function (comparator) {
    for (
      var _i = 0, _c = Array.from(listenerMap.values());
      _i < _c.length;
      _i++
    ) {
      var entry = _c[_i];
